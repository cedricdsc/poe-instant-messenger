import type { PreloadExposed } from '../../main/preload';
import type { IpcEvent, IpcEventPayload } from '../../main/IpcEvent/IpcEvent';
...
/* eslint class-methods-use-this: ["error", { "exceptMethods": ["sendEvent"] }] */
class MainProcessBinding {
  ...
  //   closeOverlay() {
  //     this.sendEvent({
  //       name: 'OVERLAY->MAIN::close-overlay',
  //       payload: undefined,
  //     });
  //   }
  ...
  //   get CORS() {
  //     return !window.electronAPI ? 'https://apt-cors.snos.workers.dev/?' : '';
  //   }
...
const MainProcess = new MainProcessBinding();
